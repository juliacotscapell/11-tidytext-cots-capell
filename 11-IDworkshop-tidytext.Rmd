...
```{r}
##We introduce the speeches as text to create the strings


obama_speech <- c("My fellow citizens:
...
trump_speech <- c("Chief Justice Roberts, President Carter, President Clinton, President Bush, President Obama, fellow Americans, and people of the world, thank you. We the citizens of America are now joined in a great national effort to rebuild our country and restore its promise for all of our people. Together we will determine the course of America, and the world, for many, many years to come. We will face challenges. We will confront hardships, but we will get the job done.
...
``` {r}
##We convert the strings into dataframes

obama_speech_df <- tibble(Text=obama_speech)
trump_speech_df <- tibble(Text=trump_speech)
...
````{r}
#We want to know the 6-most-common used words by each of the presidents in their inauguration speeches
together_clean %>% 
  group_by(president) %>% 
  count(word) %>% 
  top_n(8)
...
````{r}
#Count the number of times they say "I"
